...
Working in a research laboratory requires being aware of the different types of hazards we use or have in the lab, how to handle them safely, and what to do in the event of a spill or an exposure incident. For the most part, we follow the [Johns Hopkins Safety policies](http://www.hopkinsmedicine.org/hse/policies/index.html), and much of this material is covered in your required safety trainings. Additional biosafety information is available in the [Biosafety in Microbial and Biomedical Laboratories (BMBL) handbook](https://www.cdc.gov/labs/BMBL.html), currently on its 6th edition. We function at BSL-1 and BSL-2 levels, so we encourage you to review these chapters in the BMBL.
...
Stay up to date with your required safety training. Online training courses can be found on the [Hopkins Medicine HSE training page](http://www.hopkinsmedicine.org/hse/training/). Please take each of the following training courses, and any additional courses relevant to your project or that you think may help you operate safely.
...
## Safe Laboratory Conduct {#safe-laboratory-conduct}
...
## Hazards in the Lab {#hazards-in-the-lab}
...
Safety Data Sheets (SDS) are found in the lab safety binder, and can be [accessed online](https://www.hopkinsmedicine.org/hse/resources/sds.html). Below are the chemical hazards we house and use in the laboratory, and their respective hazards:
...
- **Biosafety Level 2 (BSL-2) hazards**: human-derived or non-human primate-derived cell lines (including U-2 OS cells); any recombinant DNA molecules used in tissue culture experiments; chicken eggs that are **UN**verified as *Salmonella*-clean

## Biohazard SOPs {#biohazard-sops}
...
*Cleanup and disinfection*: After working with bacterial cultures, always disinfect your workspace (surfaces, tools, etc) with 70% ethanol and paper towels. In the event of a large spill, follow the [Spill Clean Up](#spill-clean-up) protocol below. When finished cleaning, dispose of your gloves, and wash your hands.
...
## Sharps Handling {#sharps-handling}
